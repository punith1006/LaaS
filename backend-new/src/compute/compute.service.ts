...
- Spark: 2 vCPU, 4GB RAM, 2GB VRAM, 8% SM - ₹120/hr (Jupyter notebooks, small apps, learning, light dev)
- Blaze: 4 vCPU, 8GB RAM, 4GB VRAM, 17% SM - ₹210/hr (web apps, APIs, moderate workloads, dev environments)
- Inferno: 8 vCPU, 16GB RAM, 8GB VRAM, 33% SM - ₹300/hr (production apps, large databases, ML training, rendering)
- Supernova: 12 vCPU, 32GB RAM, 16GB VRAM, 67% SM - ₹360/hr (enterprise workloads, large-scale ML, heavy production)
